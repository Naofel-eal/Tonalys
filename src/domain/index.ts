export * from './model/note/note-name';
export * from './model/note/note';
...
export * from './model/scale/scale';

export * from './model/keyboard/key';
export * from './model/keyboard/keyboard-layout';
